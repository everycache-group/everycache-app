...
class TestCacheCommentGet:
    ...
    @pytest.mark.parametrize("logged_in_user_role", list(User.Role))
    def test_get_author_deleted(self, logged_in_user_role, client, logged_in_user):
        cache_comment = CacheCommentFactory()
...
class TestCacheCommentPut:
    ...
    @pytest.mark.parametrize("logged_in_user_role", list(User.Role))
    def test_put_cache_comment_not_found(
        self, logged_in_user_role, client, _put_data, logged_in_user
    ):
        headers = get_headers_for_user(logged_in_user, logged_in_user_role)
    ...
    @pytest.mark.parametrize("logged_in_user_role", list(User.Role))
    def test_put_cache_comment_deleted(
        self, logged_in_user_role, client, _put_data, logged_in_user
    ):
        cache_comment = CacheCommentFactory(deleted=True)
        headers = get_headers_for_user(logged_in_user, logged_in_user_role)
    ...
    def test_put_other_users_cache_comment_by_admin(
        self, client, _put_data, logged_in_user
    ):
        cache_comment = CacheCommentFactory()
    ...
    @pytest.mark.parametrize("logged_in_user_role", list(User.Role))
    def test_put_by_deleted_user(
        self, logged_in_user_role, client, _put_data_dict, logged_in_user
    ):
        user, *_ = logged_in_user
        user.deleted = True
...
class TestCacheCommentDelete:
    @pytest.mark.parametrize("logged_in_user_role", list(User.Role))
    def test_delete_cache_comment_not_found(
    ...
    @pytest.mark.parametrize("logged_in_user_role", list(User.Role))
    def test_delete_cache_comment_deleted(
        self, logged_in_user_role, client, logged_in_user
    ):
        cache_comment = CacheCommentFactory(deleted=True)
        headers = get_headers_for_user(logged_in_user, logged_in_user_role)
    ...
    def test_delete_unauthorized(self, client):
        ...
        db.session.refresh(cache_comment)
