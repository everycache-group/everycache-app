...
class TestCacheVisitPut:
    ...
    @pytest.mark.parametrize("logged_in_user_role", list(User.Role))
    def test_put_cache_visit_not_found(
    ...
    @pytest.mark.parametrize("logged_in_user_role", list(User.Role))
    def test_put_cache_visit_deleted(
        self, logged_in_user_role, client, _put_data, logged_in_user
    ):
        cache_visit = CacheVisitFactory(deleted=True)
        headers = get_headers_for_user(logged_in_user, logged_in_user_role)
    ...
    def test_put_other_users_cache_visit_by_admin(
...
class TestCacheVisitDelete:
    @pytest.mark.parametrize("logged_in_user_role", list(User.Role))
    def test_delete_cache_visit_not_found(
    ...
    @pytest.mark.parametrize("logged_in_user_role", list(User.Role))
    def test_delete_cache_visit_deleted(
        self, logged_in_user_role, client, logged_in_user
    ):
        cache_visit = CacheVisitFactory(deleted=True)
        headers = get_headers_for_user(logged_in_user, logged_in_user_role)
